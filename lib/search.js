...
export const addFilterCondition = ({
  ...
  if (operator === 'in') {
    ...
    expressionAttributeValues[`:${attributeName}`] = attributeValue.toString();
...
export const addFilterConditionRange = ({
  ...
  if (attributeValueFrom)
    expressionAttributeValues[`:${attributeName}From`] =
      attributeValueFrom.toString();

  if (attributeValueTo)
    expressionAttributeValues[`:${attributeName}To`] =
      attributeValueTo.toString();
...
export const getSortKeyCondition = ({
  ...
  expressionAttributeValues[`:${sortKeyName}`] = sortKeyValue.toString();
...
export const getSortKeyConditionRange = ({
  ...
  if (sortKeyValueFrom)
    expressionAttributeValues[`:${sortKeyName}From`] =
      sortKeyValueFrom.toString();

  if (sortKeyValueTo)
    expressionAttributeValues[`:${sortKeyName}To`] = sortKeyValueTo.toString();
