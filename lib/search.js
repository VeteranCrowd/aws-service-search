 ...
 * @function
 * @param {object} options - config object
 * @param {object} options.dbClient - The Wrapped DynamoDB client.
 ...
 * @function
 * @param {object} options - config object
 * @param {object} options.entityManager - The entity manager.
...
export const getSortKeyCondition = ({
  ...
  return ['begins_with', 'contains'].includes(operator)
